...
![ASP.NET Core](https://img.shields.io/badge/ASP.NET%20Core-6.0%2B-green)
...
- **.NET SDK**: 6.0 or 8.0 (download from [dotnet.microsoft.com](https://dotnet.microsoft.com))
